...
class Book
{
    ...
    public function getPublisherSerializedArray(): array{
        $result=[];
        foreach($this->publisher->getIterator() as $i => $item) {
    ...
    public function clearPublisher(): static
    {
    ...
    public function getAuthorSerializedArray(): array{
        $result=[];
        //dd($this->author->getIterator());
        foreach($this->author->getIterator() as $i => $item) {
            $result[]=array('id'=>$item->getId(),'name'=>$item->getName());
        }
        return $result;
    }
